...
function submitEvent() {
    const title = document.getElementById('Judul-acara').value;
    const date = document.getElementById('Tanggal-acara').value;
    const time = document.getElementById('Waktu-acara').value;
    const location = document.getElementById('Lokasi-acara').value;
    const description = document.getElementById('deskripsi-acara').value;
    const category = document.getElementById('kategori-acara').value;
    const studentName = document.getElementById('Nama-mahasiswa').value;
    
    // Handle image upload
    const imageInput = document.getElementById('Gambar-acara');
    let imageData = '';
